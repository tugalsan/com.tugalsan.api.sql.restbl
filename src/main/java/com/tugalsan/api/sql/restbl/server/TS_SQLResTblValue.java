...
public class TS_SQLResTblValue {
    ...
    public String getTableName() {
        ...
        if (first_ == -1) {
            throw new RuntimeException("getTableName.tableAndColumnName:[" + tableAndColumnName + "].first_.indexOf('.') == -1");
        }
    ...
    public String getLinkedTableName() {
        ...
        int first_, second_;
        {
            first_ = cn.indexOf('_');
            if (first_ == -1) {
                throw new RuntimeException("getLinkedTableName.tableAndColumnName:[" + tableAndColumnName + "]&rest:[" + cn + "].first_.indexOf('_') == -1");
            }
            second_ = cn.indexOf('_', first_ + 1);
            if (second_ == -1) {
                throw new RuntimeException("getLinkedTableName.tableAndColumnName:[" + tableAndColumnName + "]&rest:[" + cn + "].second_.indexOf('_') == -1");
            }
        }
    ...
    public String getLinkedColName() {
        ...
        int first_, second_;
        {
            first_ = cn.indexOf('_');
            if (first_ == -1) {
                throw new RuntimeException("getLinkedColName.tableAndColumnName:[" + tableAndColumnName + "]&rest:[" + cn + "].first_.indexOf('_') == -1");
            }
            second_ = cn.indexOf('_', first_ + 1);
            if (second_ == -1) {
                throw new RuntimeException("getLinkedColName.tableAndColumnName:[" + tableAndColumnName + "]&rest:[" + cn + "].second_.indexOf('_') == -1");
            }
        }
